...
config :hachiware, Hachiware.Poller, {0, 0, 10, 0}
...
#
#     PHX_SERVER=true bin/hachiware start
#
# Alternatively, you can use `mix phx.gen.release` to generate a `bin/server`
# script that automatically sets the env var above.
if System.get_env("PHX_SERVER") do
  config :hachiware, HachiwareWeb.Endpoint, server: true
end
...
if config_env() == :prod do
  ...
  config :hachiware, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")
